...
from src.test_case.test_project_K3P import project_name
...
def main():
    ...
    test_case_path = '/'.join([os.path.dirname(__file__), 'test_case', 'test_project_K3P.py::Test_PerformanceIndex'])
